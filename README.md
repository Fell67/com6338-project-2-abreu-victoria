...
3. Person (person.js): This keeps track of the friendship level of each person and what their difficulty level is at. It will determine the response of the person based on the difficulty/points earned during events and initially meeting Kiba. This class is also responsible for applying the friendship multiplier to the event points and then adding the friendship points to the person.
#### Events
